export const WEBINAR_META = {
  Webinar: {
    title: "Webinar - 2023",
    subtitle:
      "Preocupaciones de los estudiantes a lo largo de su formación profesional: implicancias para la formación inicial del profesorado.",
...
export const TALLER_META = {
  ...
  "Taller n°5 2023": {
    title: "Taller N° 5",
    subtitle:
      "¿Como hacer investigación a partir de actividades de aprendizaje matemático para futuros profesores?",
  ...
  "Taller N° 3 2024": {
    title: "Taller N° 10",
    subtitle:
      "Cómo investigar la propia práctica favorece el aprendizaje de los profesores en formación: cuatro experiencias para analizar",
    relatores:
      "Marco Catalán, Valentina Giaconi, Francisca Ubilla, Marcia Villena, Francisco Álvarez y Loreto Alvarado",
  ...
  "Taller N° 4 2025": {
    title: "Taller N° 15",
    subtitle:
      "De la postulación a la adjudicación: Experiencias y aprendizajes en la postulación a un Fondecyt de Iniciación",
...
// Orden explícito para encuentros
export const ENCUENTRO_ORDER = [
  "1er Encuentro Atacama",
  "2do Encuentro Osorno",
  "3er Encuentro Magallanes",
];
...
export const PRESENTACIONES_CONFIG = [
  { col: "Presenta Osorno", title: "Encuentro - Osorno" },
  { col: "Presenta Magallanes", title: "Encuentro - Magallanes" },
];


const orderByList = (order, aId, bId) => {
...
const parseDateFromId = (id) => {
  // dd/mm/yyyy dentro del id
  const m = String(id).match(/(\d{2})\/(\d{2})\/(\d{4})/);
 ...
 * Cada bloque define:
 * - title (header)
 * - iconKey (para elegir icono en la página)
 * - valueLabel (texto debajo del número)
 * - filter/sort para tomar eventos desde byEvent
 * - meta: diccionario con title/subtitle/relatores/desc por id exacto
 */
